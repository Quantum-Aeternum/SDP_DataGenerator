...
export class NumberMultiplication extends NumberManipulator{
  ...
  public clone(): Random {
    let clone: NumberMultiplication = new NumberMultiplication(<RandomNumber>this.left.clone(), <RandomNumber>this.right.clone());
  ...
  public getType(): DataType {
    return DataType.NumberMultiplication;
  }
